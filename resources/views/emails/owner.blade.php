                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="top"
                                background="{{ asset('assets/images/dashboard/bg.png') }}"
                                        ...
                                        <tr>
                                            <td align="center" style="line-height: 0px;">
                                                <img style="display:block; line-height:0px; font-size:0px; border:0px;"
                                                    src="{{ asset('assets/images/logo/logo-trans.png') }}"
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td align="center"
                                ...
                                {{trans('Configuration du compte Propriétaire')}}</td>
                        </tr>
                        ...
                        <tr>
                            <td align="center"
                                ...
                                {{trans('Bienvenu')}} ! {{$owner->firstname}} <br>
                                {{trans('Vous etes un nouveau client Sherin')}}; {{trans('Vous pouvez maintenant utiliser toutes nos service sur l\'application SHERIN')}} .<br>
                                <table>
                                    <thead>
                                      <tr>
                                        <th>{{trans('Nom')}}</th>
