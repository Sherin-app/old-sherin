         ...
         <ul class="sidebar-links custom-scrollbar">
            ...
            <li class="sidebar-main-title">
               <div>
                  ...
                  <h6 class="lan-1">{{ trans('Configuration') }}  </h6>
                  <p class="lan-2">{{ trans('Propriétaires,Magasins,Employés.') }}</p>
                  {{-- <p class="lan-2">{{ trans('lang.Dashboards,widgets & layout.') }}</p> --}}
               </div>
            </li>
            <li class="sidebar-list">
               <label class="badge badge-success">2</label><a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/dashboard' ? 'active' : '' }}" href="#"><i data-feather="settings"></i><span class="lan-3">{{ trans('Configurations') }} </span>
               ...
               <ul class="sidebar-submenu" style="display: {{ request()->route()->getPrefix() == '/dashboard' ? 'block;' : 'none;' }}">
                  <li><a class="lan-4 {{ Route::currentRouteName()=='index' ? 'active' : '' }}" href="{{route('admin.owners')}}">{{ trans('Propriétaires') }}</a></li>
                  <li><a class="lan-4 {{ Route::currentRouteName()=='index' ? 'active' : '' }}" href="{{route('admin.activities')}}">{{ trans('Activitées') }}</a></li>
                  <li><a class="lan-5 {{ Route::currentRouteName()=='dashboard-02' ? 'active' : '' }}" href="{{route('admin.stores')}}">{{ trans('Magasins') }}</a></li>
                  <li><a class="lan-5 {{ Route::currentRouteName()=='dashboard-02' ? 'active' : '' }}" href="{{route('admin.employees')}}">{{ trans('Employés') }}</a></li>
                  <li><a class="lan-5 {{ Route::currentRouteName()=='dashboard-02' ? 'active' : '' }}" href="{{route('admin.products')}}">{{ trans('Produits') }} {{trans('et Prestations')}}</a></li>
               </ul> 
            </li>
            <li class="sidebar-main-title">
               <div>
                  {{-- <h6 class="lan-1">{{ trans('lang.General') }}  </h6> --}}
                  <h6 class="lan-1">{{ trans('Campagnes') }}  </h6>
                  <p class="lan-2">{{ trans('Campagnes,Models,SMS,Bulletins') }}</p>
                  {{-- <p class="lan-2">{{ trans('lang.Dashboards,widgets & layout.') }}</p> --}}
               </div>
            </li>
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/templates' ? 'active' : '' }}" href="{{route('admin.templates')}}"><i data-feather="align-justify"></i><span class="lan-6">{{ trans('Models') }}</span></a>
            </li>
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/templates' ? 'active' : '' }}" href="{{route('admin.campaigns')}}"><i data-feather="volume"></i><span class="lan-6">{{ trans('Campagnes') }}</span></a>
            </li>
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/dashboard' ? 'active' : '' }}" href="#"><i data-feather="send"></i><span class="lan-3">{{ trans('SMS') }} </span>
                  <div class="according-menu"><i class="fa fa-angle-{{request()->route()->getPrefix() == '/dashboard' ? 'down' : 'right' }}"></i></div>
               </a>
               <ul class="sidebar-submenu" style="display: {{ request()->route()->getPrefix() == '/dashboard' ? 'block;' : 'none;' }}">
                  <li><a class="lan-4 {{ Route::currentRouteName()=='index' ? 'active' : '' }}" href="{{route('admin.sms.campaign')}}">{{ trans('SMS Campagne') }}</a></li>
                  <li><a class="lan-5 {{ Route::currentRouteName()=='dashboard-02' ? 'active' : '' }}" href="{{route('admin.unique')}}">{{ trans('SMS Quick Send') }}</a></li>
                  <li><a class="lan-5 {{ Route::currentRouteName()=='dashboard-02' ? 'active' : '' }}" href="{{route('admin.sms.campaigns')}}">{{ trans('Liste Campagnes') }}</a></li>
                  <li><a class="lan-5 {{ Route::currentRouteName()=='dashboard-02' ? 'active' : '' }}" href="{{route('admin.sms.uniques')}}">{{ trans('List Unique') }}</a></li>
               </ul> 
            </li>
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/dashboard' ? 'active' : '' }}" href="#"><i data-feather="mail"></i><span class="lan-3">{{ trans('Newsletter') }} </span>
                  <div class="according-menu"><i class="fa fa-angle-{{request()->route()->getPrefix() == '/dashboard' ? 'down' : 'right' }}"></i></div>
               </a>
               <ul class="sidebar-submenu" style="display: {{ request()->route()->getPrefix() == '/dashboard' ? 'block;' : 'none;' }}">
                  <li><a class="lan-4 {{ Route::currentRouteName()=='index' ? 'active' : '' }}" href="{{route('admin.sms.campaign')}}">{{ trans('E-mail Campagne') }}</a></li>
                  <li><a class="lan-5 {{ Route::currentRouteName()=='dashboard-02' ? 'active' : '' }}" href="{{route('admin.sms.campaigns')}}">{{ trans('Liste e-mail') }}</a></li>
               </ul> 
            </li>
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/models' ? 'active' : '' }}" href="{{route('admin.campaigns')}}"><i data-feather="users"></i><span class="lan-6">{{ trans('Clients') }}</span></a>
            </li>
            <li class="sidebar-list">
               <a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/dashboard' ? 'active' : '' }}" href="#"><i data-feather="bar-chart"></i><span class="lan-3">{{ trans('Rapports') }} </span>
                  <div class="according-menu"><i class="fa fa-angle-{{request()->route()->getPrefix() == '/dashboard' ? 'down' : 'right' }}"></i></div>
               </a>
               <ul class="sidebar-submenu" style="display: {{ request()->route()->getPrefix() == '/dashboard' ? 'block;' : 'none;' }}">
                  <li><a class="lan-4 {{ Route::currentRouteName()=='index' ? 'active' : '' }}" href="{{route('admin.report.campaign')}}">{{ trans('Campagnes') }}</a></li>
                  <li><a class="lan-5 {{ Route::currentRouteName()=='dashboard-02' ? 'active' : '' }}" href="{{route('admin.report.sms')}}">{{ trans('Envois SMS') }}</a></li>
                  <li><a class="lan-5 {{ Route::currentRouteName()=='dashboard-02' ? 'active' : '' }}" href="{{route('admin.report.charge')}}">{{ trans('Unités de Crédit') }}</a></li>
               </ul> 
            </li>
