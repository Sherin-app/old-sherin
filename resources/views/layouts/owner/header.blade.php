      ...
      <div class="form-group w-100">
        <div class="Typeahead Typeahead--twitterUsers">
          <div class="u-posRelative">
            <input class="demo-input Typeahead-input form-control-plaintext w-100" type="text" placeholder="recherche SHERIN .." name="q" title="" autofocus />
          ...
          <div class="translate_wrapper">
            ...
            <div class="more_lang">
              ...
              <a href="{{ route('lang' , 'ae' )}}" class="{{ (App::getLocale()  == 'ae') ? 'active' : ''}}">
                <div class="lang {{ (App::getLocale()  == 'ae') ? 'selected' : ''}}" data-value="en"><i class="flag-icon flag-icon-ma"></i> <span class="lang-txt">لعربية</span> <span> (AR)</span></div>
              </a>
            </div>
          </div>
        </li>
