                  ...
                  <div class="col-md-12">
                    <div class="checkout-details">
                      <div class="order-box">
                        ...
                        <ul class="qty">
                          <li>SMS ( {{ $price = auth()->user()->id===11 ? 1.99 : Config::get('constant.sms_price')}} MAD )<span>{{ $first_total = number_format((float)($countSms * ( $price ) ), 2, '.', '')}} MAD</span></li>
                          <li>EMAIL ( {{Config::get('constant.email_price')}} MAD )<span>{{ $seconde_total = number_format((float)($emails * ( Config::get('constant.email_price') ) ), 2, '.', '')}} MAD</span></li>
                        </ul>
                        <ul class="sub-total">
                          <li>Subtotal <span class="count"> {{$seconde_total + $first_total}} MAD</span></li>
                        </ul>
                        <ul class="sub-total total">
                          <li>Total <span class="count"> {{$seconde_total + $first_total}} MAD</span></li>
                        </ul>
