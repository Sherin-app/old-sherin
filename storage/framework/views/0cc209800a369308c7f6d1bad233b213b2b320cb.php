...
<?php $__env->startSection('breadcrumb-title'); ?>
    <h3 class="text-center"><?php echo e(trans('Mes Produits')); ?></h3>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('breadcrumb-items'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(url('dashboard/owner')); ?>"><?php echo e(trans('dashboard.dashboard')); ?></a></li>
    <li class="breadcrumb-item active"><?php echo e(trans('Produits')); ?></li>
<?php $__env->stopSection(); ?>
			...
			<div class="card">
				<div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                <form id="importList" action="<?php echo e(route('owner.import.products')); ?>" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <div class="row">
                                      ...
                                      <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <button type="button" onclick="importProducts($('#store_id').val())" class="btn btn-info"
                                                ><?php echo e(trans('Importer')); ?></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
						...
						<table class="display datatables" id="render-datatable">
							<thead>
								<tr>
									...
									<th><?php echo e(trans('Prix de vente')); ?></th>
									<th><?php echo e(trans('Prix d\'achat')); ?></th>
									<th><?php echo e(trans('Quantité du stock')); ?></th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            ...
                                            <li><a href="<?php echo e(url('/owner/products/'.$item->id.'/edit')); ?>"><i class="fa fa-pencil" title="<?php echo e(trans('Modifier')); ?>"></i></a></li>
                                        </ul>
                                    </td>
                                </tr>
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input readonly class="form-control " id="validationServer02" type="text" value="<?php echo e($item->store->name); ?>" data-original-title="" title="<?php echo e(trans('Magasin')); ?>">
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <div class="form-group">
                                                                <label for="exampleFormControlSelect9"><?php echo e(trans('Prix de vente')); ?></label>
                                                                <input readonly class="form-control " id="validationServer01" type="text" value="<?php echo e($item->price); ?>"  required="" data-original-title="" title="<?php echo e(trans('Prix de vente')); ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            <label for="validationServer01"><?php echo e(trans('Quantite du stock')); ?></label>
                                                            <input readonly class="form-control " id="validationServer01" type="text" value="<?php echo e($item->quantite); ?>"  required="" data-original-title="" title="<?php echo e(trans('Quantité du stock')); ?>">
                                                        </div>
...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg">
       <div class="modal-content">
          ...
          <div class="modal-body">
                <form action="<?php echo e(route('owner.products.store')); ?>" method="POST" >
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control " id="validationServer01" type="text" name="label"  required="" data-original-title="" title="<?php echo e(trans('libelle')); ?>">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="validationServer01"><?php echo e(trans('Prix de vente')); ?></label>
                            <input class="form-control " id="validationServer01" type="text" name="price"  required="" data-original-title="" title="<?php echo e(trans('Prix de vente')); ?>">
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control " id="validationServer02" type="text" name="quantite" data-original-title="" title="<?php echo e(trans('La quantité')); ?>">
                        </div>
                    </div>
